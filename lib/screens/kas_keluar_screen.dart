...
class _KasKeluarScreenState extends State<KasKeluarScreen> {
  // var items = <Kas>[
  //   Kas.keluar(
  //       keterangan: 'beli air', nominal: 2000, dateTime: DateTime.now()),
  //   Kas.keluar(
  //       keterangan: 'beli dimsum', nominal: 50000, dateTime: DateTime.now()),
  //   Kas.keluar(
  //       keterangan: 'beli celana ',
  //       nominal: 100000,
    ...
    await showDialog(
      context: context,
       builder: (context) => AlertDialog(
        ...
        content: const Text('Anda yakin ingin menghapus kas keluar tersebut?'),
        actions: [
          ElevatedButton(
            onPressed: () { 
